...
<body>
    ...
    <form action="{{ $_ENV['BASE_URL'] }}/users/store" method="post" enctype="multipart/form-data">
        <div>
        ...
        <div>
            ...
            <input type="email" name="email" id="">  {{-- day file anh len:  enctype="multipart/form-data"--}}
        </div>
        <div>
